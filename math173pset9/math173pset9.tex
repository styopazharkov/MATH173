...
Now, problem 3(b) and the fact that $H_0^1((a,b)) \sse H^1((a,b)) \sse C([a,b])$ gives us the same bounding argument as in chapter 9.1, leading us to conclude the statement for all $f \in H^1((a,b))$. 
