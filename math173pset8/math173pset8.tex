...
\begin{enumerate}[(a)]
    \item Consider the operator $T: H^1 \to H^1$ where $Tf = f - \intzo f$. It's easy to see that $T$ is linear since integration is linear. We see that for any $f \in C^1((0,1))$,
    \begin{align*}
        ...
        &= ||f||_{H^1}.
    \end{align*}
    By density, the argument extends to $f \in H^1((0,1))$
    \item TODO
\end{enumerate}
