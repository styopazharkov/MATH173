...
\begin{enumerate}[(a)]
    ...
    The $n= 0$ and combined $|n| = 1$ cases are similarly easy to check.
    ...
    \hop 
    A nicer way to show the above is to notice that setting $z = re^{i\theta}$, we have $P_r(\theta) = \text{Re}\del{\frac{1+z}{1-z}}$ and then use the fact that the real part of a holomorphic function is harmonic. With this method, we do not need to worry about the origin. However, we do not know this complex analysis fact in this class.
    \hop 
